...
<main>
    <div class="container-fluid px-4">
        ...
        <a class="btn btn-success" href="{{ route('categories.create') }}"><i class="fas fa-plus"></i> &nbsp;New category</a><br><br>
                ...
                <form method="GET" action="{{route ('categories.index')}}">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('categories.index') }}" class="btn btn-secondary">Clear</button></a>
                        </div>
                    </div>
                </form>
            </div>
